...
class Search():
    ...
    def __init__(self, name):
        ...
        # Attributes for the sailor's actual location when found
        self.area_actual = 0
    ...
    def calc_search_efffectiveness(self):
...
def draw_menu(search_num):
    """Prints menu of choises for conducting area searches."""
    print(f'\nSearch {search_num}')
    print(
        """
...
def main():
    ...
    while True:
        app.calc_search_efffectiveness()
        ...
        print(f"\nSearch {search_num} Effectiveness (E):", file=sys.stderr)
